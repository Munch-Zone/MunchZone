...
public class TabBitmap {
	...
	private static final int UNSELECTED_COLOR =Color.rgb(102, 102, 102);
	private static final int SELECTED_COLOR = Color.rgb(255,255,255);
	...
	private static Bitmap create(Resources res, Bitmap src, boolean isSelected) {
		...
		if (isSelected) {
			...
			colors[0] =Color.rgb(102, 102, 102);
			colors[1] =Color.rgb(102, 102, 102);
			colors[2] =Color.rgb(102, 102, 102);
			colors[3] =Color.rgb(102, 102, 102);
		}
